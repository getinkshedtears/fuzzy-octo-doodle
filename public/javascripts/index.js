...
/***/ function(module, exports, __webpack_require__) {
	...
	var _store = __webpack_require__(/*! ./store */ 166);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(Topbar, { user: this.state.user }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'wrapper' },
	                    _react2.default.createElement(Search, { location: this.state.search, user: this.state.user, error: this.state.error }),
	                    _react2.default.createElement(Display, { locations: this.state.locations, loading: this.state.loading, user: this.state.user })
	                )
	            );
	        }
	    }]);
	...
	var Login = function (_React$Component2) {
	    ...
	    function Login(props) {
	        ...
	        _this2.getClass = _this2.getClass.bind(_this2);
	        _this2.toggleLogin = _this2.toggleLogin.bind(_this2);
	        return _this2;
	    }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'login', onClick: this.toggleLogin },
	                        'Login'
	                    )
	                ),
	                _react2.default.createElement(
	...
	var Topbar = function (_React$Component3) {
	    _inherits(Topbar, _React$Component3);
	...
	var Search = function (_React$Component4) {
	    ...
	    function Search(props) {
	        ...
	        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(Search).call(this, props));
	    ...
	    _createClass(Search, [{
	        ...
	        value: function updateSearch(e) {
	            _actions2.default.updateSearch(e.target.value);
	        }
	    }, {
	        key: 'handleSubmit',
	        value: function handleSubmit(e) {
	            ...
	            _actions2.default.fetchLocations(this.props.location);
	
	            if (this.props.user) {
	                _actions2.default.setLastSearch(this.props.location);
	            }
	        }
	    }, {
	        key: 'placeholder',
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'text-youarehere' },
	                        'You are here: '
	                    ),
	                    _react2.default.createElement('input', { type: 'text', placeholder: this.placeholder(), onChange: this.updateSearch }),
	                    _react2.default.createElement('input', { type: 'submit', value: 'find me bars' })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'err' },
	...
	var Display = function (_React$Component5) {
	    ...
	    function Display(props) {
	        ...
	        var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(Display).call(this, props));
	
	        _this5.showLocations = _this5.showLocations.bind(_this5);
	    ...
	    _createClass(Display, [{
	        ...
	        value: function showLocations() {
	            return this.props.locations.map(function (location) {
	                return _react2.default.createElement(Location, { location: location, user: this.props.user });
	            }.bind(this));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'display' },
	                this.props.loading ? _react2.default.createElement('div', { className: 'loader' }) : this.showLocations()
	            );
	        }
	    }]);
	...
	var Location = function (_React$Component6) {
	    _inherits(Location, _React$Component6);
	
	    function Location(props) {
	        _classCallCheck(this, Location);
	
	        var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(Location).call(this, props));
	
	        _this6.showAttending = _this6.showAttending.bind(_this6);
	        return _this6;
	    }
	
	    _createClass(Location, [{
	        key: 'showAttending',
	        value: function showAttending() {
	            if (this.props.user) {
	                if (this.props.user.attending.indexOf(this.props.location.id) >= 0) {
	                    return _react2.default.createElement(
	                        'div',
	                        { className: 'add-attending', onClick: _actions2.default.removeAttending.bind(null, this.props.location.id) },
	                        'Never mind'
	                    );
	                } else return _react2.default.createElement(
	                    'div',
	                    { className: 'add-attending', onClick: _actions2.default.addAttending.bind(null, this.props.location.id) },
	                    'I\'m going!'
	                );
	            } else return null;
	        }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { src: this.props.location.rating_img_url })
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'location-review' },
	                        this.props.location.snippet_text
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	...
	_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('anchor'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alt = __webpack_require__(/*! ./alt */ 167);
	...
	var Store = function () {
	    function Store() {
	        ...
	        this.bindListeners({
	            handleUpdateSearch: _actions2.default.UPDATE_SEARCH,
	            handleFetchLocations: _actions2.default.FETCH_LOCATIONS,
	            handleUpdateLocations: _actions2.default.UPDATE_LOCATIONS,
	            handleUpdateUser: _actions2.default.UPDATE_USER,
	            handleUpdateAttending: _actions2.default.UPDATE_ATTENDING,
	    ...
	    _createClass(Store, [{
	        ...
	        value: function handleUpdateSearch(search) {
	            this.search = search;
	        }
	    }, {
	        key: 'handleUpdateLocations',
	        value: function handleUpdateLocations(data) {
	            this.loading = false;
	            this.locations = data;
	        }
	    }, {
	        ...
	        key: 'handleUpdateAttending',
	        value: function handleUpdateAttending(obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alt = __webpack_require__(/*! alt */ 168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flux = __webpack_require__(/*! flux */ 169);
	
	var _StateFunctions = __webpack_require__(/*! ./utils/StateFunctions */ 172);
	
	var StateFunctions = _interopRequireWildcard(_StateFunctions);
	
	var _functions = __webpack_require__(/*! ./functions */ 173);
	...
	var _AltUtils = __webpack_require__(/*! ./utils/AltUtils */ 175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.Dispatcher = __webpack_require__(/*! ./lib/Dispatcher */ 170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(/*! fbjs/lib/invariant */ 171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltStore = __webpack_require__(/*! ./AltStore */ 176);
	
	var _AltStore2 = _interopRequireDefault(_AltStore);
	
	var _StoreMixin = __webpack_require__(/*! ./StoreMixin */ 178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transmitter = __webpack_require__(/*! transmitter */ 177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPromise = __webpack_require__(/*! is-promise */ 180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superagent = __webpack_require__(/*! superagent */ 182);
	...
	var Actions = function () {
	    ...
	    _createClass(Actions, [{
	        ...
	        key: 'updateAttending',
	        value: function updateAttending(obj) {
	            return obj;
	        }
	    }, {
	        key: 'addAttending',
	        value: function addAttending(id) {
	            _superagent2.default.post('/api/addAttending').send({ id: id }).end(function (err, data) {
	                this.updateAttending(data.body);
	            }.bind(this));
	        }
	    }, {
	        key: 'removeAttending',
	        value: function removeAttending(id) {
	            _superagent2.default.post('/api/removeAttending').send({ id: id }).end(function (err, data) {
	                this.updateAttending(data.body);
	            }.bind(this));
	        }
	    }, {
	        key: 'fetchLocations',
	        value: function fetchLocations(search) {
	            var _this = this;
	
	            return function (dispatch) {
	                dispatch();
	                _superagent2.default.post('./api/yelp').send({ location: search }).end(function (err, data) {
	        ...
	        value: function fetchUser() {
	            ...
	            _superagent2.default.post('./api/getUser').end(function (err, data) {
	                if (data.body) {
	        ...
	        key: 'setLastSearch',
	        value: function setLastSearch(search) {
	            _superagent2.default.post('/api/setLastSearch').send({ search: search }).end(function (err, data) {
	                console.log(data);
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(/*! emitter */ 183);
	var reduce = __webpack_require__(/*! reduce */ 184);
	var requestBase = __webpack_require__(/*! ./request-base */ 185);
	var isObject = __webpack_require__(/*! ./is-object */ 186);
	...
	var request = module.exports = __webpack_require__(/*! ./request */ 187).bind(null, Request);
